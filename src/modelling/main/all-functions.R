...
bagged_model <- function(train, test, label_train, alpha, s_lambda, times, calibrate = FALSE) {
  ...
  #' @param calibrate a logical: should the probabilities output by the trained model be calibrated? If TRUE, probabilities are calibrated using platt scaling. If FALSE, probabilities are left unprocessed. Default = FALSE.
  #'
  #' @return 
