...
trainModel.oneRep = function(rep.index, innerFolds, mainTrain){
  ...
  ############################################################################################
  # Trains one repetition of the entire model.
  #
  # Arguments:
  #
  # rep.index -- an integer from one to the number of repetitions
  # innerFolds -- a list of folds generated by createMultiFolds in caret
  # mainTrain -- the training dataset from which innerFolds is derived from
  #
  # Returns:
  #
  # tibble
  #  A tibble that contains the best alpha and lambda hyperparameters found.
  #
  ############################################################################################
