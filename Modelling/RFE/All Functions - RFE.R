...
baggedModel = function(train, test, label_train, alpha.a, s_lambda.a, times, calibrate = FALSE){
  ...
  #' @param alpha.a a numeric value in [0,1] to train each elastic net model with in the bag.
  #' @param s_lambda.a an integer value in {1, 2, 3, .... infinity} for subsetting the prediction matrix generated by glmnet. 
...
platt.scale = function(label_train, predicted.prob.train, predicted.prob.test){
  ...
  #' @param predicted.prob.train  a numeric vector of probabilities generated on the training dataset 
  #' @param predicted.prob.test a numeric vector of probabilities generated on the testing dataset
  #'
  #' @return 
