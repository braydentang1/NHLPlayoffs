...
2. Open up the .R file in the Modelling folder, called "Bagged Elastic Net.r". Alternatively, open up the Jupyter Notebook in Jupyter. 
...
4. Open up the .R file in the Modelling folder, called "Bagged Elastic Net.r". Alternatively, open up the Jupyter Notebook in Jupyter. 
